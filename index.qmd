...
df |> 
  select(-pos, -transducer_entry, -transducer_lexicon_group) |> 
  arrange(zilo) |> 
...
df |> 
  ...
  mutate(gender = factor(gender)) |> 
  datatable(filter = 'top', escape = FALSE, rownames = FALSE,
            colnames = c("русский", "зиловский", "класс", "мн. ч.", "косв. осн. ед. ч.", "косв. осн. мн. ч.", "местн. п.", "кл. формы", "прош. вр.", "повел."),
            options = list(pageLength = 20, 
                           dom = 'ftop',
                           initComplete = JS(readLines("code.js"))))
```
