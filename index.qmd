...
df |> 
  ...
  mutate(more = '&oplus;') |> 
  mutate(gender = if_else(gender == "", "", str_c("gender: ", gender)),
         abs.pl = if_else(abs.pl == "", "", str_c("abs.pl: ", abs.pl)),
         obl.sg = if_else(obl.sg == "", "", str_c("obl.sg: ", obl.sg)),
         obl.pl = if_else(obl.pl == "", "", str_c("obl.pl: ", obl.pl)),
         loc = if_else(loc == "", "", str_c("locative: ", loc)),
         GA = if_else(GA == "", "", str_c("gender forms: ", GA)),
         aor_perf = if_else(aor_perf == "", "", str_c("aor_perf: ", aor_perf)),
         imp = if_else(imp == "", "", str_c("imp: ", imp)),
         more = '&oplus;',
         tooltip = str_c(gender, "<br>",
                         abs.pl, "<br>",
                         obl.sg, "<br>",
                         obl.pl, "<br>",
                         loc, "<br>",
                         ...
                         aor_perf, "<br>",
                         imp, "<br>"),
         tooltip = str_replace_all(tooltip, "(<br>){1,}", "<br>"),
         tooltip = str_remove_all(tooltip, "^<br>")) |>
  select(more, tooltip, zilo, russian) |> 
